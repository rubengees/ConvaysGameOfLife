...
public class BoardTest {
    ...
    @Test
    public void testSetAliveMatrix() throws Exception {
        boolean[][] aliveMatrix = new boolean[3][4];
        ...
        expected[1][1] = new Cell(true, 1, 1);
        expected[1][2] = new Cell(true, 1, 2);
        expected[1][3] = new Cell(true, 1, 3);
        expected[2][0] = new Cell(false, 2, 0);
        expected[2][1] = new Cell(false, 2, 1);
        expected[2][2] = new Cell(false, 2, 2);
        expected[2][3] = new Cell(false, 2, 3);
    ...
    public void testSetAliveMatrixTooSmall() throws Exception {
        board.setAliveMatrix(new boolean[2][2]);
    }

    @Test
    public void testGetCell() throws Exception {
        Cell expected = new Cell(false, 2, 3);

        Assert.assertEquals(expected, board.getCell(2, 3));
    }

    @Test(expected = IllegalArgumentException.class)
    public void testGetCellOutOfBounds() throws Exception {
        board.getCell(100, 100);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testGetCellOutOfBoundsNegative() throws Exception {
        board.getCell(-1, 3);
    }

    @Test
    public void testInvertCell() throws Exception {
        Cell expected = new Cell(true, 2, 3);

        board.invertCell(2, 3);

        Assert.assertEquals(expected, board.getCell(2, 3));
    }

    @Test(expected = IllegalArgumentException.class)
    public void testInvertCellOutOfBounds() throws Exception {
        board.invertCell(100, 100);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testInvertCellOutOfBoundsNegative() throws Exception {
        board.invertCell(3, -5);
    }
}